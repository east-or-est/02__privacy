...
ディライブポイント - ポートフォリオ（以下「当サイト」といいます）は、技術的なことや、仕事の業界に関することを適当にまとめる備忘録サイトです。
...
当サイトに掲載されているイラスト・デザイン等の制作物の情報は、外部サイト・サービス・作品を紹介するバナーや画像等、テーマ既存の画像等を除いて、当サイトの管理者が著作権を有しています。
